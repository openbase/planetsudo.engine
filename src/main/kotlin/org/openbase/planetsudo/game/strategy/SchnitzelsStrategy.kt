...
class SchnitzelsStrategy(agent: AgentInterface) : StrategyLevel3(agent) {
    ...
    override fun loadRules() {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(902, "Trägt Resource") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(903, "Beim Mutterschiff und Tankcheck") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(904, "Beim Mutterschiff und Resource") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(950, "Unter beschuss") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(400, "Mutterschiff reparieren") {
                override fun constraint(): Boolean {
