 ...
 */
class LevelTwo(agent: AgentInterface) : StrategyLevelLegacy(agent) {
    ...
    override fun loadRules() {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(30, "PickUp Resource") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(100, "TurnToAdversaryAgent") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(110, "SaveMothership") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(120, "RepaireMothership") {
                override fun constraint(): Boolean {
        ...
        // -------------------------------------------->
        createRule(
            object : Rule(200, "GoBackToMothership") {
                override fun constraint(): Boolean {
