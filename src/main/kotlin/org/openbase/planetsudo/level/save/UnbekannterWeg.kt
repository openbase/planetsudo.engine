 ...
 */
class UnbekannterWeg : AbstractLevel() {
    ...
    override fun loadResourcePlacement() = listOf(
        ...
        ResourceRandomRectangle(0, 350, 350, 300, 10, ResourceType.Tonic),
        ResourceRandomRectangle(650, 350, 350, 300, 10, ResourceType.Tonic),
    )
