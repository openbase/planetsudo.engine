 ...
 */
class CircleOfLife : AbstractLevel() {
    ...
    override fun loadResourcePlacement() = listOf(
        ResourceRandomRectangle(0, 0, 400, 1000, 10, ResourceType.Normal),
        ResourceRandomRectangle(600, 0, 400, 1000, 10, ResourceType.Normal),
        ...
        ResourceRandomRectangle(0, 950, 1000, 50, 15, ResourceType.Tonic),
    )
