 ...
 */
class QuadratischPraktischGut : AbstractLevel() {
    ...
    override fun loadResourcePlacement() = listOf(
        ResourceRandomRectangle(0, 500, 500, 600, 20, ResourceType.Normal),
        ResourceRandomRectangle(1100, 500, 500, 600, 20, ResourceType.Normal),
        ...
        ResourceRandomRectangle(0, 700, 100, 200, 10, ResourceType.Tonic),
        ResourceRandomRectangle(1000, 700, 100, 200, 10, ResourceType.Tonic)
    )
