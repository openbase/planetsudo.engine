...
public class QuadratischPraktischBoese extends AbstractLevel {
	...
	protected ResourcePlacement[] loadResourcePlacement() {
		...
		resourcePlacement[0] = new ResourceRandomRectangle(500, 300, 600, 200, 10, ResourceType.Normal);
                resourcePlacement[1] = new ResourceRandomRectangle(500, 1100, 600, 200, 10, ResourceType.Normal);
