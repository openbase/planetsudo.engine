 ...
 * @author Grimmy
 */
public class Atomum extends AbstractLevel {
	...
	protected Polygon[] loadLevelWallPolygons() {
            		Polygon[] resourcePlacement = new Polygon[5];
		...
		resourcePlacement[0].addPoint(900, 800);
                resourcePlacement[0].addPoint(800, 900);
		...
		resourcePlacement[1].addPoint(1100, 800);
                resourcePlacement[1].addPoint(1200, 900);
		...
		resourcePlacement[2].addPoint(900, 1200);
                resourcePlacement[2].addPoint(800, 1100);
		...
		resourcePlacement[3].addPoint(1100, 1200);
                resourcePlacement[3].addPoint(1200, 1100);
                ...
                resourcePlacement[4] = new Polygon();
                resourcePlacement[4].addPoint(900, 1000);
                resourcePlacement[4].addPoint(1000, 900);
                resourcePlacement[4].addPoint(1100, 1000);
                resourcePlacement[4].addPoint(1000, 1100);
