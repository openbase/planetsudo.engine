...
class MarcosStrategy(agent: AgentInterface) : AbstractStrategy(agent) {
    ...
    override fun loadRules() {
        ...
        createRule(object : Rule(20, "Gehe zu Resource") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(30, "Resource aufsammeln") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(40, "Helfe Teammitglied") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(50, "Carry Resource back") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(60, "Resource abgeben") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(70, "Attackiere feindl. Mutterschiff") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(80, "Leerer Tank - Zurück gehen") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(90, "Tanken") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(100, "Fire in the house!") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(110, "Repariere Mutterschiff") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(120, "Fight!") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(130, "Alarm!") {
            override fun constraint(): Boolean {
        ...
        createRule(object : Rule(1000, "Collision detected") {
            override fun constraint(): Boolean {
