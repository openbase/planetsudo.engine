...
public class GamePanel extends javax.swing.JPanel {
    ...
    public void updateDynamicComponents() throws InterruptedException {
        levelDisplayPanel.setLevel(GameManager.getGameManager().getLevel());
        levelDisplayPanel.displayLevelObjects();
        teamMenuPanel1.setTeam(GameManager.getGameManager().teamA);
        teamMenuPanel2.setTeam(GameManager.getGameManager().teamB);
        levelMenuPanel.setLevel(GameManager.getGameManager().getLevel());
