...
//		});
    ...
    protected void paintShape(final Graphics2D g2) {
        switch (resource.shape) {
            case Oval:
                g2.fillOval((int) resource.position.getX() - ((int) resource.width / 2), (int) resource.position.getY() - ((int) resource.height / 2), (int) resource.width, (int) resource.height);
                break;
            case Rec:
                g2.fillRect((int) resource.position.getX() - ((int) resource.width / 2), (int) resource.position.getY() - ((int) resource.height / 2), (int) resource.width, (int) resource.height);
                break;
        }
    }
    ...
    public AffineTransform getRotationTransformation(Direction2D direction, Dimension2D dimension, AffineTransform affineTransform) {
        affineTransform.rotate(Math.toRadians(direction.angle + 90),
    ...
    private int xa1 = (int) resource.position.getX();
    private int xa2 = (int) resource.position.getX();
    private int xa3 = (int) resource.position.getX();
    private int ya1 = (int) resource.position.getY();
    private int ya2 = (int) resource.position.getY();
    private int ya3 = (int) resource.position.getY();
    private int xb1 = (int) resource.position.getX();
    private int xb2 = (int) resource.position.getX();
    private int xb3 = (int) resource.position.getX();
    private int yb1 = (int) resource.position.getY();
    private int yb2 = (int) resource.position.getY();
    private int yb3 = (int) resource.position.getY();
