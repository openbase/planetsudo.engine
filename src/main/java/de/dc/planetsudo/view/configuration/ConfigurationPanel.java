...
import de.dc.planetsudo.net.PlanetSudoClient.ConnectionState;
import static de.dc.planetsudo.net.PlanetSudoClient.ConnectionState.SyncSuccessful;
...
//	private Team defaultTeam;
	...
	private void initDynamicComponents() {
		...
		try {
			...
			Logger.warn(this, "Could not load default team!", ex);
		}
	}
			...
			protected Object doInBackground() throws Exception {
				if (LevelChooserComboBox.getSelectedItem() != null) {
					...
					levelPreviewDisplayPanel.setBackground(level.getColor());
						...
						Logger.error(this, "Could not update level preview!", ex);
					}
				}
				return null;
			}
