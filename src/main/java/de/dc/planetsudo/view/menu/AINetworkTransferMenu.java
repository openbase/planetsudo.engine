	...
	public void updateTeamList() {
		...
		for (String teamClassName : teamClassNameList) {
			if (teamClassName.endsWith(".team")) {
				...
				try {
					ObjectFileController<Team> readerController = new ObjectFileController<Team>(CLParser.getAttribute(SetTeamPathCommand.class).getValue().getAbsolutePath() + "/" + teamStringID + ".team");
