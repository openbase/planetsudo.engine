...
package de.dc.planetsudo.view;

import de.dc.planetsudo.view.configuration.ConfigurationPanel;
import de.dc.planetsudo.view.game.GamePanel;
...
public class MainGUI extends javax.swing.JFrame implements PropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent changeEvent) {
		Logger.debug(this, "PropertyChange input: "+changeEvent.getPropertyName());
		try {
			...
			Logger.debug(this, "Exception from PropertyChange");
		}
	}
